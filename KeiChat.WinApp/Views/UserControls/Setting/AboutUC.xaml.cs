...
namespace KeiChat.WinApp.Views.UserControls.Setting
{
    /// <summary>
    /// AboutUC.xaml 的交互逻辑
    /// </summary>
    public partial class AboutUC : UserControl
    {
        public AboutUC()
        {
            InitializeComponent();
            // 显示版本信息。
            VersionTextBlock.Text = "6.0.9.0";
        }

        public void CheckUpdateButton_Click(object sender, System.Windows.RoutedEventArgs e)
        {
